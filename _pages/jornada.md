...
[Envío de pósters](https://forms.google.com/TU-LINK-AQUI){: .btn .btn--primary .btn--large}
[Registro asistentes](https://forms.google.com/TU-LINK-AQUI){: .btn .btn--primary .btn}
[Fechas importantes](#fechas-importantes){: .btn .btn--warning}
[Programa](#programa){: .btn .btn--info}
...
Consolidar un espacio académico para la presentación, discusión y articulación de investigaciones en información y cómputo cuántico, promoviendo la interacción entre investigadores, estudiantes de posgrado y grupos emergentes.

### Objetivos específicos

- Visibilizar las líneas activas de investigación en el área.
- Facilitar la interacción entre grupos de investigación del instituto y universidades invitadas.
- Promover la creación de colaboraciones científicas y fortalecer la comunidad académica local en ciencias de la información cuántica.
...
[Envío de pósters](https://forms.google.com/TU-LINK-AQUI){: .btn .btn--primary .btn}
...
Roberto Navarro Arenas (Chair) - `rnavarroa1600@alumno.ipn.mx`\\
